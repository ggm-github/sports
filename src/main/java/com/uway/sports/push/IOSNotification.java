...
public abstract class IOSNotification extends UmengNotification {
	...
	protected static final HashSet<String> APS_KEYS = new HashSet<String>(Arrays.asList(new String[]{
			"alert", "badge", "sound", "content-available","title", "subtitle", "body","image","mutable-content","category"
	}));

	protected static final HashSet<String> ALETR_KEYS = new HashSet<String>(Arrays.asList(new String[]{
			"title", "subtitle", "body"
	}));
	...
	public void setImage(String token) throws Exception {
		setPredefinedKeyValue("image", token);
	}
	public void setMutablecontent(String token) throws Exception {
		setPredefinedKeyValue("mutable-content", token);
	}
	...
	public void setCategory(String token) throws Exception {
		setPredefinedKeyValue("category", token);
	}

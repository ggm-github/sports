...
public abstract class AndroidNotification extends UmengNotification {
	...
	protected static final HashSet<String> BODY_KEYS = new HashSet<String>(Arrays.asList(new String[]{
			...
			"sound", "after_open", "url", "activity", "custom","expand_image"}));
	...
	public void setmipush(String mipush) throws Exception {
		setPredefinedKeyValue("mipush", mipush);
	}

	public void setMiactivity(String mi_activity) throws Exception {
		setPredefinedKeyValue("mi_activity", mi_activity);
	}
	public void setExpand_image(String expand_image) throws Exception {
		setPredefinedKeyValue("expand_image", expand_image);
	}

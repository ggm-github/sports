...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static String getMacAddr(HttpServletRequest request) throws IOException {
    ...
    public static String toUnderScoreCase(String s) {
		...
		if(sb.toString().equals("start_time")){
					return "date_format("+sb.toString()+",'%Y-%m-%d')";
		}
        return sb.toString();
    }
    ...
    public static boolean isExists(String[] source,String str) {

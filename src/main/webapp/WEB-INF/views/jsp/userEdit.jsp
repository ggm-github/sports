...
<html style="background:url(${ctxStatic}/img/sysBg.png)">
			...
			<div id="content">
			      <div class="row" style="min-width:900px;">	
				        ...
				        <div id="userInfo" class="form-horizontal col-lg-6 col-md-6 col-sm-6 col-xs-6" style="margin-top:30px;">
				                <input id="userId" name="userId" type="text" hidden="hidden" value="${userEntity.userId}">
					            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
					                <div class="form-group">
						                <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" for="userName">登录名：</label>
						                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
						                     <input class="form-control" type="text" id="userName" name="userName" placeholder="请输入登录名" value="${userEntity.userName}" readonly>
						                </div>					    
								    </div>								    
					            </div>
							    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
									    <div class="form-group">
										    ...
										    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input class="form-control" type="text" id="chName" name="chName" placeholder="请输入真实姓名" value="${userEntity.chName}">
											</div>
										</div>
								</div>
								<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
										<div class="form-group">
										    ...
										    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input class="form-control" type="text" id="phone" name="phone" placeholder="请输入手机号" value="${userEntity.phone}">
											</div>
										</div>
								</div>
								<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
										<div class="form-group">
										    ...
										    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<input class="form-control" type="text" id="mail" name="mail" placeholder="请输入邮箱" value="${userEntity.mail}">
											</div>
										</div>
								</div>
								<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
											<select class="form-control" id="roleId" name="roleId">
												<c:forEach items="${sysRoleList}" var="item">
													<option
															<c:if test="${userEntity.roleId == item.roleId}">
																selected="selected"
															</c:if>
										...
										<div class="form-group">
										    ...
										    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<select class="form-control" id="status"  name="status">
													<option
														<c:if test="${userEntity.status == 0}">
														     selected="selected"
						                                </c:if> value="0">
					                                    无效</option>
					                                <option
														<c:if test="${userEntity.status == 1}">
														     selected="selected"
						                                </c:if> value="1">
					                                    有效</option>
	...
	<script type="text/javascript">
		...
		function ajaxSave(){
			    ...
			    $.ajax({
			        url: "${contextPath}/user/updateUserInfo",
